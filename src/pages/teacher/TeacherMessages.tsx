...
const TeacherMessages = () => {
  const { teacherProfile, currentUser } = useStore();
  ...
  const handleSendMessage = async () => {
    try {
      await create({
        ...
        senderName: teacherProfile?.name || currentUser?.name || "Teacher",
        senderRole: "teacher",
        recipientId: "admin",
        recipientRole: "admin",
  ...
  const filteredMessages = teacherMessages.filter(
    (m) =>
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <span className={`px-2 py-0.5 rounded-full text-xs font-medium ${
                        ...
                        message.senderRole === "teacher" ? "bg-green-100 text-green-700" :
                        "bg-gray-100 text-gray-700"
                      }`}>
                        {message.senderRole}
                      </span>
                      {!message.read && message.senderRole !== "teacher" && (
